...
rr[cluster$last, cluster_end[1]] = rr.ratio
rr[cluster$last, cluster_end[2]] = rr.ratio
...
save(JBCresults.sim, file="SimulationOutput//simR2_center50_r125_50_r18.RData")
####################################################
#Risk Ratios
####################################################
...
pdf("figures/simulations/japan_map_R1_25_center_50_disjoint_p2_p5.pdf", height=11, width=10)
...
####################################################
#Create Empty PDF to Map Onto
pdf("figures/simulations/japan_probmap_R1_25_center_50_disjoint_p2_p5.pdf", height=11, width=10)
