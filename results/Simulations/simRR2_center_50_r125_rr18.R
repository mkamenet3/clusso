...
pdf("figures/simulations/japan_map_R1_25_5periods.pdf", height=11, width=10)
...
####################################################
#Create Empty PDF to Map Onto
pdf("figures/simulations/japan_probmap_center_50_r125_rr18.pdf", height=11, width=10)
