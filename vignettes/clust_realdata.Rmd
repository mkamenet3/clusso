...
easyplot(japan.prefect2, japan.poly2 ,pdfname, res$rrcolors, mods, space="both", probmap=FALSE, rr=TRUE)
```
...
easyplot(dframe.prefect2, dframe.poly2 ,pdfname, res$rrcolors, mods, space="both", probmap=FALSE, cv=10, obs=TRUE)
...
easyplot(dframe.prefect2, dframe.poly2 ,pdfname, res$rrcolors, mods, space="both", obs=TRUE)
```
