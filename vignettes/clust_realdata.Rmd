...
The fourth argument is the number of time periods measurements were taken during (`Time`, or 5 in our data). **TODO: address missing data; make this unnecessary if analysis="space"**
...
More importantly, however, we can send diagnostics to a csv for further analysis and create maps based on our results.
...
write.csv(table.clusters, file="tableclusters_codechange_2019_03_19.csv", row.names=TRUE)
