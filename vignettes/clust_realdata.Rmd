...
easyplot(japan.prefect2, japan.poly2 ,pdfname, res$rrcolors, mods, space="both", probmap=FALSE, cv=10, rr=TRUE)
...
easyplot(japan.prefect2, japan.poly2 ,pdfname, res$rrcolors, mods, space="both", obs=TRUE,rr=TRUE)
```
