...
system.time(resrealnew <- clust(clst, x,y, rMax, Time, utm=TRUE, byrow=TRUE, space="both", overdispfloor=TRUE, cv=NULL))


#system.time(resreal <- clust(clst, x,y, rMax, Time, utm=TRUE, analysis="both"))
...
#filename <- paste0("jbc_analysis_8_24_18",".RData")
filename <- paste0("jbc_analysis_9_13_18",".RData")
...
#pdfname <- paste0("jbc_analysis_8_24_18",".pdf")
pdfname <- paste0("jbc_analysis_9_13_18",".pdf")
...
#pdfname <- paste0("jbc_analysisBIC_8_24_18",".pdf")
pdfname <- paste0("jbc_analysisBIC_9_13_18",".pdf")
