...
```{r}
#save results
filename <- paste0("jbc_analysis_new",".RData")
save(res, file = filename)


#Create Empty PDF to Map Onto
pdfname <- paste0("jbc_analysis_new",".pdf")
easyplot(japan.prefect2, japan.poly2 ,pdfname, res$rrcolors, mods, space="both", probmap=FALSE, obs=TRUE,rr=TRUE)

#BIC map
pdfname <- paste0("jbc_analysisBIC_new",".pdf")
easyplot(japan.prefect2, japan.poly2 ,pdfname, res, mods, space="BIC", probmap=FALSE,rr=TRUE)
...
write.csv(table.clusters, file="tableclusters_codechange.csv", row.names=TRUE)
