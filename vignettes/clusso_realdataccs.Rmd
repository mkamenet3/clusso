...
system.time(resreal <- clusso(df=ccsjbc, expected = n, observed = numcases,timeperiod = factor(period), covars=FALSE,
...
```{r}
clussopretty(resccs, analysis="both", model="binomial",clusteridentify=FALSE)
```
