...
```{r}
japanbreastcancer<- japanbreastcancer[,-1] #get rid of id column to use clst functionl
...
overdispfloor <- TRUE
#nsim <- 100
nsim <- 5 #again, nsim is limited to 100 here for illustration only. For an actual simulation, nsim=100 is recommended
threshold <- c(0.9, 0.5)
mods <- c("QuasiPoisson", "Poisson")
