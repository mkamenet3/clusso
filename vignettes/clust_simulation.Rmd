...
```{r}
centers <- 75 #can take values 1 - 208 because we have a total of 208 centroids
radii <- 11
...
system.time(res <- clust_sim(clst, x, y,rMax,dframe$period, dframe$expdeath, dframe$death, Time,
                                     nsim,cent, rad, risk, tim, utm=TRUE, byrow=TRUE, threshold, 
                                     space= "both", theta, nullmod, floor))
