...
easyplot(prefect = dframe.prefect2 , polygons = dframe.poly2 ,pdfname1, res$rrcolors, mods, space="both", probmap=FALSE, obs = NULL, rr=TRUE)
easyplot(prefect = dframe.prefect2 , polygons = dframe.poly2 ,pdfname2, res$probcolors, mods, space="both", probmap=TRUE, obs = NULL,rr=FALSE)
easyplot(prefect = dframe.prefect2 , polygons = dframe.poly2 ,pdfname3, res$probcolors.thresh1, mods, space="both", probmap=TRUE, obs = NULL,rr=FALSE)
easyplot(prefect = dframe.prefect2 , polygons = dframe.poly2 ,pdfname4, res$probcolors.thresh2, mods, space="both", probmap=TRUE, obs = NULL, rr=FALSE)
    ...
    for(rad in radii){
        for(tim in timeperiods){
            for(risk in risk.ratios){
                ...
                ##maps
                easyplot(prefect = dframe.prefect2 , polygons = dframe.poly2, pdfnamerr, res$rrcolors, mods, space="both",probmap=FALSE, obs=NULL, rr=TRUE)
                easyplot(prefect = dframe.prefect2 , polygons = dframe.poly2, pdfnameprob, res$probcolors, mods, space="both",probmap=TRUE, obs=NULL, rr=FALSE)
                easyplot(prefect = dframe.prefect2 , polygons = dframe.poly2, pdfnamethresh1, res$probcolors.thresh1, mods, space="both",probmap=TRUE, obs=NULL, rr=FALSE)
                easyplot(prefect = dframe.prefect2 , polygons = dframe.poly2, pdfnamethresh2, res$probcolors.thresh2, mods, space="both",probmap=TRUE, obs=NULL, rr=FALSE)
...
easyplot(prefect = dframe.prefect2 , polygons = dframe.poly2 ,pdfname1, res$rrcolors, mods, space="both", probmap=FALSE, obs = NULL)
easyplot(prefect = dframe.prefect2 , polygons = dframe.poly2 ,pdfname2, res$probcolors, mods, space="both", probmap=TRUE, obs = NULL)
easyplot(prefect = dframe.prefect2 , polygons = dframe.poly2 ,pdfname3, res$probcolors.thresh1, mods, space="both", probmap=TRUE, obs = NULL)
easyplot(prefect = dframe.prefect2 , polygons = dframe.poly2 ,pdfname4, res$probcolors.thresh2, mods, space="both", probmap=TRUE, obs = NULL)
