...
system.time(resrealccs <- clusso(df=ccsjbc, expected = n, observed = numcases,timeperiod = period,id=id,
                                 covars=FALSE, x= x,y = y, rMax =  rMax, utm=TRUE, 
                                 analysis="both", model="binomial",maxclust=11))
...
system.time(resccscv <- clusso(ccsjbc, expected = n, observed = numcases,timeperiod = period, id=id,
                               covars=FALSE, x= x,y = y, rMax =  rMax, utm=TRUE, 
                               analysis="both", model="binomial",maxclust=11, cv=5))
...
system.time(resccscovars<- clusso(ccsjbc, expected = n, observed=numcases,timeperiod = period, id=id,
                                  covars=TRUE, x= x,y = y, rMax =  rMax, utm=TRUE,
                                  analysis="both", model="binomial",maxclust=11))
